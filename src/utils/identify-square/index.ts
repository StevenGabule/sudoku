...
/**
 * A function that identifies and returns the current square of a given sudoku grit at a row and column index.
 * @param input object with 9x9 sudoku grid, row index and column
 * */
